...
def get_loaders_eval(dataset, args):
    ...
    if dataset == 'cifar10':
        ...
        if dataset == 'celeba_64':
            ...
            train_data = dset.CelebA(root="/data/10707project/", split="train", download=False, transform=train_transform)
            valid_data = dset.CelebA(root="/data/10707project/", split="valid", download=False, transform=valid_transform)
